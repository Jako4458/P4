# EBNF
    ...
    Func    -> func id lparen Params rparen [RetType] FuncBody
    ...
    IfExpr  -> if BoolExpr do [\n Stmnts] \n Elif \n endif
            |  if BoolExpr do [\n Stmnts] [\n Else] \n endif

    Elif    -> elif BoolExpr do [\n Stmnts] \n Elif
            |  elif BoolExpr do [\n Stmnts] [\n Else] \n endif

    Else    -> else do [\n Stmnts]

    For     -> for Assign until BoolExpr where CompAssign do [\n Stmnts] \n endfor

    Foreach ->  foreach Type id in id do [\n Stmnts] \n endfor
    
    While   -> while BoolExpr do [\n Stmnts] \n endwhile

    DoWhile -> do [\n Stmnts] \n while BoolExpr endwhile
    
    MCExpr  -> $<function already defined in mcfunction> \n
    ...
    String_literal -> '<Any character except " (U+0022), \\ (U+005C), and New_line_literal>'     <!--- Stolen from C# LS -->
