...
public class ParseFuncCallTests {
    ...
    void wrongCall(RepetitionInfo rI) throws IOException {
        helper.setupFromFile("/parser/test/parser/func_call/func_call_wrong" + rI.getCurrentRepetition() + ".ms");
    ...
    void correctCall(RepetitionInfo rI) throws IOException {
        helper.setupFromFile("/parser/test/parser/func_call/func_call_correct" + rI.getCurrentRepetition() + ".ms");
