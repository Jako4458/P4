...
exponentExpr : exponentExpr 'Pow' exponentExpr
       | unaryExpr
       ;
...
vector2Literal : '<' (numberLiteral | ID) ',' (numberLiteral | ID) '>'
               ;

vector3Literal : '<' (numberLiteral | ID) ',' (numberLiteral | ID) ',' (numberLiteral | ID) '>'
                ;
